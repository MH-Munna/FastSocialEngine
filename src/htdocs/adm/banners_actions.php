...
switch($_REQUEST['action']){
    case 'add':
        ...
        header('location: '.base_site_url.'/adm/banner_edit.php?id='.$ban_info['id']);
    break;
    case 'delete':
        $ban = new banner($_REQUEST['ban_id']);
        $ban->banner_delete();
        header('location: '.base_site_url.'/adm/banners.php');
    break;
    case 'get_list':
    ...
    case 'upload_banner':
        ...
        header('location: '.base_site_url.'/adm/banner_edit.php?id='.$_REQUEST['ban_id']);
        break;
    case 'del_image':
        $ban = new banner($_REQUEST['ban_id']);
