...
<form action="banners_actions.php" method="post">
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="text" name="ban[ts_stop]" value="{$banner.ts_start}" /></td>
        </tr>
        <tr>
            <td>Изображение:</td>
            <td>
        ...
        <tr>
            <td>Тип баннера(1 - не слайд, 2 - слайд)</td>
            <td><input type="text" name="ban[i_slide]" value="{$banner.i_slide}" /></td>
        </tr>
        <tr>
